...
global.URL = argv.URL;
global.module_tech_name = 'pscookiebanner';
...
module.exports = {
	...
	//Installation
	 ...
	 //BO
        ...
        configuration_step: '//*[@id="modulecontent"]/div[1]/div[1]/a[1]',
        configuration_preview_mode_step: '//*[@id="cb-preview"]',
        configuration_banner_position: '//*[@id="buylaterConf"]/div[1]/div[3]/div/div/ul/li[1]/label[1]',
        configuration_banner_close_btn: '//*[@id="cookiebanner-container"]/a',
        configuration_banner_save_btn: '//*[@id="submitCookieBannerModule"]',
        configuration_banner_green_validation: '//*[@id="content"]/div[5]/div[@class="module_confirmation conf confirm alert alert-success"]',
        configuration_banner_background: '//*[@id="cookiebanner-container"]',
        configuration_background_color_input: '//*[@id="color_0"]',
        configuration_text_textarea: '//*[@id="cookiebanner-container"]/div[2]/div[1]',
        configuration_text: '//*[@id="cookiebanner-container"]/div[2]',
        configuration_font_text_select_option: '//*[@id="CB-FONT-STYLE"]/option[4]',
        configuration_font_size_text_input: '//*[@id="buylaterConf"]/div[1]/div[10]/div[2]/input',
        configuration_color_text_input: '//*[@id="color_3"]',
        configuration_link: '//*[@id="cookiebanner-container"]/div[2]/div[2]',
        configuration_link_href: '//*[@id="cookiebanner-container"]/div[2]/div[2]/a',
        configuration_link_text_input: '//*[@id="buylaterConf"]/div[1]/div[11]/div/div[2]/input',
        configuration_button_text_color_input: '//*[@id="color_5"]',
        configuration_button_background_color_input: '//*[@id="color_2"]',
        configuration_button_mouse_ouver_input: '//*[@id="color_4"]',
        configuration_banner_button: '//*[@id="cookiebanner-container"]/div[2]/div[3]/button',
        configuration_banner_button_accept_text_input: '//*[@id="buylaterConf"]/div[1]/div[14]/div/div[2]/input',
        configuration_banner_postion_top: '//*[@id="buylaterConf"]/div[1]/div[3]/div/div/ul/li[1]/label[1]',
        configuration_banner_postion_top_input: '//*[@id="buylaterConf"]/div[1]/div[3]/div/div/ul/li[1]/label[1]/input',
        configuration_banner_postion_bottom: '//*[@id="buylaterConf"]/div[1]/div[3]/div/div/ul/li[2]/label[1]',
        configuration_banner_postion_bottom_input: '//*[@id="buylaterConf"]/div[1]/div[3]/div/div/ul/li[2]/label[1]/input',
        configuration_banner_postion_bottomright: '//*[@id="buylaterConf"]/div[1]/div[3]/div/div/ul/li[3]/label[1]',
        configuration_banner_postion_bottomright_input: '//*[@id="buylaterConf"]/div[1]/div[3]/div/div/ul/li[3]/label[1]/input',
        configuration_banner_postion_bottomleft: '//*[@id="buylaterConf"]/div[1]/div[3]/div/div/ul/li[4]/label[1]',
        configuration_banner_postion_bottomleft_input: '//*[@id="buylaterConf"]/div[1]/div[3]/div/div/ul/li[4]/label[1]/input',
        configuration_banner_cms_page: '//*[@id="CB-CMS"]/option[6]',
        configuration_banner_cms_page_option3: '//*[@id="CB-CMS"]/option[3]',
        configuration_banner_textarea: '//*[@id="buylaterConf"]/div[1]/div[6]/div/div[2]/textarea',
