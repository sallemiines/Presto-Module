...
describe('Test n°1 = Check the stores configuration', function () {
    ...
    describe('Check the store address', function (done) {
        it('should go to the contact  subtab', function (done) {
            this.client
                .waitForExist(this.selector.BO.SettingPage.setting__subtab, 90000)
                ...
                .pause(5000)
                .waitForExist(this.selector.BO.ContactPage.shop_link, 90000)
                .click(this.selector.BO.ContactPage.shop_link)
                .waitForExist(this.selector.BO.ContactPage.adress_shop_input, 90000)
                .setValue(this.selector.BO.ContactPage.adress_shop_input, 'rue de boulvard')
                .waitForExist(this.selector.BO.ContactPage.postal_code_input, 90000)
                .setValue(this.selector.BO.ContactPage.postal_code_input, '75001')
                .waitForExist(this.selector.BO.ContactPage.city_shop_input, 90000)
                ...
                .waitForExist(this.selector.BO.ContactPage.fax_input, 90000)
                .setValue(this.selector.BO.ContactPage.fax_input, '12345678')
                .pause(3000)
                .waitForExist(this.selector.BO.ContactPage.save_button, 90000)
