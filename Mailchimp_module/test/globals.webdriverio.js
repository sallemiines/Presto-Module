...
module.exports = {
	...
	//Installation
	 ...
	 //BO
        ...
        setting_btn:'//*[@id="content"]/div[6]/ul/li[2]/a',
		...
		config_btn:'//*[@id="modules-list-container-all"]/div/div/div/div[5]/div[2]/form/button',
        connect_store_btn:'//*[@id="configuration_form_submit_btn"]',
        login_acces_mailchimp:'//*[@id="username"]',
        password_acces_mailchimp:'//*[@id="password"]',
        login_mailchimp:'//*[@id="login-form"]/fieldset/div[3]/input',
        mailchimp_panel:'//*[@id="fieldset_0"]/div[1]',
        mailchimp_listes:'//*[@id="current_list_id"]/option[2]',
        email_list:'//*[@id="current_list_id"]',
        save_mailchimp_liste:'//*[@id="configuration_form_submit_btn"]',
        connect_msg:'//*[@id="content"]/div[4]/div/div/span',
	...
	//FO
        ...
        First_product:'//*[@id="content"]/section[1]/div[2]/article/div/a',
